...
namespace NokPortalAPI.Repositories
{
    ...
    public interface IUserAppRoleAssignmentRepository
    {
        ...
        Task<int> RemoveUserAppRoleAssignmentAsync(int id);
        ...
        Task<UserAppRoleAssignment?> FindUserAppRoleAssignmentAsync(int id);
        ...
        Task<bool> ExistsAsync(int userId, int appId, int roleId);
        ...
        Task<bool> ExistsAssignmentAsync(int userId, int appId);
        ...
        Task<List<int>> FindRoleIdsAsync(int userId, int appId);
        ...
        /// <param name="appId">The application ID.</param>
        /// <returns>A list of role IDs.</returns>
        Task<IList<int>> FindRoleIdsByAppAsync(int userId, int appId);
        ...
        Task<int> RemoveUserAppRoleAssignmentsAsync(int userId, int appId);
    }
}