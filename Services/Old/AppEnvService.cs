...
namespace NokPortalAPI.Services.Old
{
    ...
    public class AppEnvService : IAppEnvService
    {
        ...
        public async Task<bool> CreateAppEnvAsync(AppEnvironment appEnv)
        {
        ...
        /// <returns>True if success, otherwise false.</returns>
        public async Task<bool> UpdateAppEnvAsync(AppEnvironment appEnv)
        {
            using var connection = connectionFactory.CreateConnection();
            connection.Open();
            using var tran = connection.BeginTransaction();
        ...
        public async Task<IEnumerable<AppEnvironment>> GetAllAppEnvAsync()
        {
            using var connection = connectionFactory.CreateConnection();
            connection.Open();
        ...
        public async Task<AppEnvironment?> GetById(int appId, int userId, EnumEnvironmentType env)
        {
            using var connection = connectionFactory.CreateConnection();
            connection.Open();
