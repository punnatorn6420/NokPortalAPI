    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_User_App_Role_Assignment", x => new { x.UserId, x.AppId, x.RoleId });
                    table.ForeignKey(
                        name: "FK_User_App_Role_Assignment_Apps_AppId",
                        column: x => x.AppId,
                        principalTable: "Apps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_User_App_Role_Assignment_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User_App_Role_Assignment_AppId",
                table: "User_App_Role_Assignment",
                column: "AppId");
