...
namespace NokPortal.Domians.Services
{
    public class JwtService : IJwtService
    {
        ...
        public dynamic GenerateToken(dynamic jwtSetting, string secretKey, int hourExpire)
        {
            ManagePayloadService jsonHelper = new ManagePayloadService();
            ...
            DateTime expiresTime = DateTime.Now.AddHours(hourExpire);
        ...
        public ClaimsPrincipal? DecodeToken(string token, string secretKey)
        {
            var tokenHandler = new JwtSecurityTokenHandler();
